...
\vspace{-1em}
  ...
  \caption{Time-to-solution measured in \gearshifft{} and in a standalone \cufft{} application---multiple timer vs. one timer object (``tts'')---computing single-precision in-place real-to-complex round-trip FFTs on the K80 \cite{taurus}.}
