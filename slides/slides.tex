...
\pause  
  ...
  \item if not "powerof2" cuFFT plan can consume $8\times$ more memory (estimated plan size also recorded by \gearshifft{}) % @todo: backup slide
  \end{itemize}
\pause
  {\textbf{clFFT}}
  \begin{itemize}
...
\begin{figure}[!tbp]
  ...
  \subfloat[3D transforms]{\includegraphics[width=0.5\textwidth]{figures/results_r2c_fwd_a.pdf}\label{fig:r2c_fwd_a}}
  \hfill
  \subfloat[1D transforms]{\includegraphics[width=0.5\textwidth]{figures/results_r2c_fwd_b.pdf}\label{fig:r2c_fwd_b}}
  \caption{\texttt{powerof2} out-of-place single-precision real-to-complex forward transforms (Taurus/E5-2680v3, Taurus/K80, Taurus/P100-PCIe, Islay/GTX1080).}
