...
\begin{figure}[!htbp]\vspace{-1em}
  ...
  \caption{\texttt{powerof2} 3D single-precision real-to-complex in-place forward transforms.}
...
\begin{figure}[!tbp]
  ...
  \caption{\texttt{powerof2} out-of-place single-precision real-to-complex forward transforms.}
