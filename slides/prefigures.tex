...
\visible<-2>{\draw[thick,latex-] (fft) --++(-2,1.5) node[pos=1.0,above,align=center] {templated\\round-trip FFT API\\(static polymorphism by\\Static Adapter design pattern)};}
\end{scope}
\begin{scope}
