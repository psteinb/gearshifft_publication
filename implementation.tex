...
\end{quote}
%
In \fftw{} terminology, \emph{wisdom} is a data structure representing a more or less optimal plan for a given transform. The \texttt{fftw\_wisdom} binary which comes with the \fftw{} bundle generates hardware adapted wisdom files, which can be loaded by the wisdom API into any \fftw{} application.
